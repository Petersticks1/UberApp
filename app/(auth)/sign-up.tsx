            ...
            <View className='flex-1 bg-white'>
                ...
                >
                    <View className='bg-white px-7 py-9 rounded-2xl min-h-[300px]'>
                        ...
                        />
                        <Text className='text-3xl text-center text-black font-JakartaSemiBold'>Verified</Text>
                        <Text className='text-base text-center text-gray-400 mt-2 font-Jakarta'>You have successfully verified your account.</Text>
                        <CustomButton
                            title='Browse Home'
                            onPress={() =>
